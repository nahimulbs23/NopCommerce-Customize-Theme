...
using Nop.Plugin.Widgets.SpecialOffers.Components;
using Nop.Services.Cms;
using Nop.Services.Plugins;
using Nop.Web.Framework.Infrastructure;

namespace Nop.Plugin.Widgets.SpecialOffers;
public class SpecialOffersPlugin : BasePlugin, IWidgetPlugin
{
    ...
    {
        return typeof(SpecialOffersWidgetViewComponent);
    }
